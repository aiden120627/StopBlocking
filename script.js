(() => {
  ...
  const IMAGE_DATA = [
    ["미래적인 도시", "SEARCHY Visual", "https://images.unsplash.com/photo-1519608487953-e999c86e7455?auto=format&fit=crop&w=800&q=80"],
  ...
  const VIDEO_DATA = [
    ["웹 개발 기초: HTML, CSS, JavaScript", "SEARCHY ACADEMY", "영상 · 12:31"],
  ...
  ========================== */
  const STORAGE = {
    history: "searchy_history",
    theme: "searchy_theme",
    engine: "searchy_engine",
    animations: "searchy_animations",
    newTab: "searchy_new_tab"
  };
